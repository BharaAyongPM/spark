<x-layout bodyClass="g-sidenav-show bg-gray-200">
    <x-navbars.sidebar activePage="jamoperasional"></x-navbars.sidebar>

    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="Kelola Jam Operasional"></x-navbars.navs.auth>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#addJamOperasionalModal">Tambah Jam Operasional</button>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($jamOperasionals as $jam)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('vendor.jamoperasional.destroy', $jam->id) }}"
                                ...
                                <div class="modal fade" id="editJamModal-{{ $jam->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <form action="{{ route('vendor.jamoperasional.update', $jam->id) }}"
                                            method="POST">
                                            @csrf
