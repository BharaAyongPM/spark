                    ...
                    <div
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ $countFields }}</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h3 class="font-weight-medium text-right mb-0">{{ $totalPesanan }}</h3>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div
                        ...
                        <div class="float-right">
                            <p class="mb-0 text-right">Total User Penyewa</p>
                            <div class="fluid-container">
